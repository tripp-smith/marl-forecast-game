...
_kalshi_rate_limiter = RateLimiter(calls_per_second=5)


@dataclass(frozen=True)
class KalshiAdapter:
    """Fetches prediction-market prices from the Kalshi trade API v2, with synthetic fallback."""
    ...
    def fetch(self, periods: int = 30) -> list[NormalizedRecord]:
        """Return up to *periods* market-price records from Kalshi or synthetic data."""
        try:
